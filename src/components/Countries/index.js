...
class Countries extends Component {
    ...
    this.setState(prevState => ({
      countries: prevState.countries.map(eachCountry => {
        if (eachCountry.id === id) {
          return {...eachCountry, isVisited: !prevState.isVisited}
        }
        return eachCountry
      }),
    }))
  ...
  onClickRemove = id => {
    ...
    const updatedList = countries.filter(eachCountry => eachCountry.id !== id)
  ...
  render() {
    ...
    return (
      <div className="country-container">
        ...
        <h1 className="bottom-head">Visited Countries</h1>
